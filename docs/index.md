...
<header class="hero" style="text-align:center; padding:60px 20px; background:#f9f9f9;">
  ...
  <h1 style="font-size:2.5em; margin:10px 0;">Furniture Deals that are <br> Sofa King Amazing</h1>
...
<section class="section">
  ...
  <div class="product-grid" style="display:flex; flex-wrap:wrap; justify-content:center; gap:20px; margin-top:30px;">
...
<section class="section newsletter" style="padding:60px 20px; text-align:center; background:#000; color:white;">
  ...
  <p style="font-size:1.1em; margin-bottom:20px;">Join our email list and receive a discount code instantly.</p>

  <!-- Zoho Campaigns Web-Optin Form Starts Here -->
  <div id="customForm" style="display:inline-block; text-align:left; max-width:400px; width:100%; background-color:rgba(255,255,255,0.05); padding:20px; border-radius:10px;">
    <div name="SIGNUP_BODY" changeitem="BG_IMAGE">
      ...
      <div>
        ...
        <form method="POST" id="zcampaignOptinForm" action="https://zgnp-zngp.maillist-manage.com/weboptin.zc" target="_zcSignup" onsubmit="zcScptlessSubmit(this)">
          <div id="errorMsgDiv" style="color:white;">Please correct the marked field(s) below.</div>
          <div>
